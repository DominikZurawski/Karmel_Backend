...
#run
'''
gunicorn --bind 0.0.0.0:5030 wsgi:app --access-logfile ./gunicorn_access.log --daemon 
...
--access-logfile to keep request log
 ...
 gunicorn --workers=5 --bind 0.0.0.0:5030 wsgi:app  --name KarmelBackend --access-logfile ./gunicorn_access.log --daemon
