...
gunicorn --chdir /app wsgi:app -w 2 --threads 6 -b 0.0.0.0:5000  --access-logfile ./gunicorn_access.log --error-logfile ./gunicorn_error.log --name KarmelBackend --log-level=debug --reload
# --daemon
# -D